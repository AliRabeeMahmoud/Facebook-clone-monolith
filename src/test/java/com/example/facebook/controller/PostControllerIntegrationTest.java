...
import com.example.facebook.exception.CommentNotFoundException;
import com.example.facebook.exception.PostNotFoundException;
import com.example.facebook.repository.*;
...
class PostControllerIntegrationTest {
    ...
    void deletePost() throws Exception {
        ...
        mockMvc.perform(delete(API_URL_PREFIX + "/posts/{postId}/delete", postOne.getId()))
                .andExpect(status().isOk());
    ...
    void deletePostPhoto() throws Exception {
        ...
        mockMvc.perform(delete(API_URL_PREFIX + "/posts/{postId}/photo/delete", postOne.getId()))
                .andExpect(status().isOk());
    ...
    void updatePostComment() throws Exception {
        ...
        mockMvc.perform(put(API_URL_PREFIX + "/posts/{postId}/comments/{commentId}/update", postTwo.getId(), commentOne.getId())
    ...
    void deletePostComment() throws Exception {
        ...
        mockMvc.perform(delete(API_URL_PREFIX + "/posts/{postId}/comments/{commentId}/delete", postTwo.getId(), commentOne.getId()))
                .andExpect(status().isOk());
    ...
    void updatePostShare() throws Exception {
        ...
        mockMvc.perform(put(API_URL_PREFIX + "/posts/{postId}/share/update", postTwoShare.getId())
    ...
    void deletePostShare() throws Exception {
        ...
        mockMvc.perform(delete(API_URL_PREFIX + "/posts/{postId}/share/delete", postTwoShare.getId()))
                .andExpect(status().isOk());
